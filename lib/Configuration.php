...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://partnerexchange.azurewebsites.net';
    ...
    {
        $report  = 'PHP SDK (d2r_connectors\conficio) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://partnerexchange.azurewebsites.net/",
